...
public class CalculatorTest {
    ...
    @Test
    public void testCalculatorAdditional() throws ParserIllegalTokenValueException, ParserUnknownEntityException {
        makeTest("tg0", 0.0);
    ...
    public void makeTest(String expression, Double expected, boolean checkForEqualing) throws ParserIllegalTokenValueException, ParserUnknownEntityException {
