...
public class NumbersUtilTest {
    ...
    private void makePrettierTest(Double number, int maxLength, Double expected) {
        assertEquals(expected, Numbers.makeLookPrettier(number, maxLength));
    }
